...
router.patch('/change-password', requireToken, (req, res, next) => {
  ...
  User.findById(req.user.id)
    ...
    .then(() => bcrypt.compare(req.body.passwords.oldpw, user.hashedPassword))
    ...
    .then(correctPassword => {
      ...
      if (!req.body.passwords.newpw || !correctPassword) {
        throw new BadParamsError()
      }
    })
    // hash the new password
    .then(() => bcrypt.hash(req.body.passwords.newpw, bcryptSaltRounds))
    .then(hash => {
